...
# File: fpnew_wrapper.tcl
# Generated on: Sat Jun 12 11:10:02 2021
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "fpnew_wrapper"]} {
		puts "Project fpnew_wrapper is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists fpnew_wrapper]} {
		project_open -revision fpnew_wrapper fpnew_wrapper
	} else {
		project_new -revision fpnew_wrapper fpnew_wrapper
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "08:07:53  MAY 25, 2021"
	...
	set_global_assignment -name SEARCH_PATH fpnew/src/common_cells/include
	set_global_assignment -name SEARCH_PATH fpnew/src/common_cells/src
	set_global_assignment -name SEARCH_PATH fpnew/src/fpu_div_sqrt_mvp/hdl
	set_global_assignment -name PROJECT_IP_REGENERATION_POLICY ALWAYS_REGENERATE_IP
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpu_div_sqrt_mvp/hdl/defs_div_sqrt_mvp.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/common_cells/src/cf_math_pkg.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/common_cells/src/rr_arb_tree.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_pkg.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_rounding.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_opgroup_multifmt_slice.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_opgroup_fmt_slice.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_opgroup_block.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_noncomp.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_fma_multi.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_fma.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_divsqrt_multi.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_classifier.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_cast_multi.sv
	set_global_assignment -name SYSTEMVERILOG_FILE fpnew/src/fpnew_top.sv
	set_global_assignment -name VHDL_FILE DE1_SoC_pkg.vhd -hdl_version VHDL_2008
	set_global_assignment -name VHDL_FILE DE1_SoC.vhd -hdl_version VHDL_2008
