  ...
  
{
  ...
  int iFreqRatio = (int)(double)(dPaymentInterval/ddelt + 0.5);		// = ratio of time gap between swap payments and HJM step-width.
  ...
  iSwapVectorLength = (int)(double)(iN - dMaturity/ddelt + 0.5);	//This is the length of the HJM rate path at the time index
  ...
  iSwapStartTimeIndex = (int)(double)(dMaturity/ddelt + 0.5);	//Swap starts at swaption maturity
  iSwapTimePoints = (int)(double)(dTenor/ddelt + 0.5);			//Total HJM time points corresponding to the swap's tenor
